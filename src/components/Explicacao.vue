  ...
  <v-app theme="light">
    <v-container class="my-5">
      <v-card elevation="5" class="px-5 py-3" color="grey-lighten-3">
        ...
        <v-card class="mt-2">
          <v-card-title>1. Peso Corporal</v-card-title>
          <v-card-text>
            ...
            ></v-img>
            <p>
              A hidratação adequada é crucial para o funcionamento do corpo. A água ajuda na regulação da temperatura, transporte de nutrientes e na eliminação de toxinas. Além disso, a desidratação pode levar a problemas como fadiga, dor de cabeça e redução da performance física.
            </p>
            <p>
              O ideal é distribuir a ingestão de água ao longo do dia, e não apenas beber grandes quantidades de uma só vez. É importante lembrar que a ingestão de alimentos ricos em água, como frutas e vegetais, também conta para a hidratação total.
            </p>
            <p>
              Se você está tentando perder peso, mantenha-se atento à sua hidratação. A desidratação pode afetar seu metabolismo e a eficiência dos exercícios, fazendo com que você sinta mais fome e reduza a intensidade dos treinos.
            </p>
          </v-card-text>
        </v-card>

        <v-card class="mt-2">
          <v-card-title>2. Atividade Física</v-card-title>
          <v-card-text>
            ...
            ></v-img>
            <p>
              Durante o exercício, é fundamental reabastecer os líquidos perdidos. A água não só ajuda a manter a temperatura corporal, mas também melhora o desempenho durante a atividade física. A falta de hidratação pode resultar em cãibras, fadiga precoce e diminuição do foco.
            </p>
            <p>
              A recomendação é começar a beber água antes de sentir sede, pois a sede é um sinal de que o corpo já pode estar desidratado. Considere a possibilidade de usar bebidas isotônicas durante atividades mais longas para repor eletrólitos.
            </p>
            <p>
              Lembre-se de que cada pessoa é única e as necessidades de hidratação podem variar. Monitore a cor da urina como um indicador de hidratação: urina clara geralmente indica boa hidratação, enquanto urina escura pode sinalizar desidratação.
            </p>
          </v-card-text>
        </v-card>

        <v-card class="mt-2">
          <v-card-title>3. Clima</v-card-title>
          <v-card-text>
        ...
        <v-card class="mt-2">
          <v-card-title>4. Consumo de Cafeína e Álcool</v-card-title>
          <v-card-text>
           ...
           <div class="d-flex mt-2 mb-2">
            ...
            <p>
              Em resumo, a conscientização sobre o que você consome e como isso afeta seu corpo pode ajudar a manter uma boa hidratação e saúde geral. Sempre que possível, escolha água em vez de bebidas adoçadas ou alcoólicas.
            </p>
          </v-card-text>
        </v-card>

        <v-btn class="mt-5" color="primary" @click="irParaCalculadora">Voltar para a Home</v-btn>
      </v-card>
    </v-container>
  </v-app>
</template>
